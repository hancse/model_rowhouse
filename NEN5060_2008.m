...
for k=1:4
 ...
 if k==1
 [NUM,TXT,RAW]=xlsread('NEN5060-A2.xls',1); % this file is part of NEN 5060 2008
 elseif k==2
 [NUM,TXT,RAW]=xlsread('NEN5060-B2.xls',1);
 elseif k==3
 [NUM,TXT,RAW]=xlsread('NEN5060-B2.xls',2);
 else
 ...
 if k==1
 save NEN5060_A2 t Tout qsunS qsunSW qsunW qsunNW qsunN qsunNE qsunE qsunSE ...
